...
_PROMPT = (
    ...
    "  • location: nome COMPLETO do local / clube / quadra (IMPORTANTE: inclua códigos como (408n), (SCES), etc.)\n"
    "  • description: bandas, artistas ou detalhes adicionais (string vazia se nenhum)\n"
    "  • price: preço do ingresso OU 'contribuição voluntária' (string com R$?? se nenhum)\n\n"
    "IMPORTANTE - LOCAIS EM BRASÍLIA:\n"
    "- Godofredo = Godofredo (408n)\n"
    "- Ispilicute = Ispilicute\n"
    "- Clube do CBMDF = Clube do CBMDF (SCES)\n"
    "- Clube dos Oficiais = Clube dos Oficiais CBMDF (SCES)\n"
    "- Infinu = Infinu (506s)\n"
    "- Tropical Beer = Tropical Beer (Ceilândia Sul)\n"
    "- Revolucionário Bar = Revolucionário Bar (Cruzeiro Velho)\n"
    "- Cervejaria Corina = Cervejaria Corina (SOFN)\n"
    "- Buteco do Encontro = Buteco do Encontro (206n)\n"
    "- Praça Chico Mendes = Praça Chico Mendes (UnB/Sitfub)\n"
    "- A Casa de Jorge = A Casa de Jorge (SAAN)\n\n"
    "Se mencionar 'contribuição voluntária', use isso como preço\n"
    "Preços podem ser 'R$10', 'R$15-20', 'contribuição voluntária', 'contribuição voluntário (preço sugerido: R$...) etc.\n\n"
